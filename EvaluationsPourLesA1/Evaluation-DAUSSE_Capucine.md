...
- Ajouter plus d'images pourrait être une bonne idée. Le seul gif présent est un peu rapide pour comprendre ce qu'il se passe réellement dans le jeu.

# Propositions d'amélioration du jeu

- Avoir un bouton qui permet de quitter à tout moment du jeu, et peut être aussi d'avoir accès à des paramètres.

- Le texte de début de partie est long et il pourrait être intéressant de mettre un bouton pour afficher tout le texte d'un coup ou le passer. Ou alors de ne pas l'afficher à chaque début de partie mais seulement à la première.

- Afficher les bulles de texte des personnages plus plus longtemps.
...
Résumer en une phrase ce que vous avez éventuellement appris : Le role d'un audit est de communiquer avec les différents employés et de chercher à savoir si ce qu'ils disent est vrai ou non, et d'en faire un rapport comtenant ce qu'il faut améliorer ou non dans l'entreprise.
